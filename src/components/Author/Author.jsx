...
export const Author = ({handler}) => {
    const info = [
        ...
        {id: 5, text: `${collection.length} историй, ${collection.length} причин коллекционировать. Больше двух тысяч предметов в коллекциях. Жёлтые резиновые утки, водка и фигурки Warhammer — добро пожаловать на полку современных коллекций.`}
    ];
