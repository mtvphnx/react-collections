...
const info = [
    ...
    {id: 5, text: 'Восемнадцать историй, Восемнадцать причин коллекционировать. Больше двух тысяч предметов в коллекциях. Жёлтые резиновые утки, водка и фигурки Warhammer — добро пожаловать на полку современных коллекций.'}
];
